  ...
  return (
    <div id="contact" className="antialiased bg-gray-100">
      <div className="flex w-full min-h-screen justify-center items-center">
        <div className="flex flex-col bg-cyan-700 md:flex-row md:space-x-6 space-y-6 md:space-y-0 w-full max-w-4xl p-8 rounded-xl shadow-lg text-white">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 text-gray-600">
            <form action="" className="flex flex-col space-y-4">
              ...
              <button className="inline-block self-end bg-cyan-700 font-bold text-white rounded-lg px-6 py-6 uppercase text-sm">
                Send Message
              </button>
            </form>
          </div>
